...
word_list_name='/l/data/siak-server-devel/models/clean-am/wordlist_random.txt' #'/home/siak/siak/aalto_recordings/prompts/wordlist_random.txt'
lex_name=sys.argv[6]
model_dir='/l/data/siak-server-devel/models/clean-am' #'/home/siak/models/clean-am/'
cfg_name='/l/data/siak-server-devel/models/clean-am/siak_clean_b.cfg' #'/home/siak/models/clean-am/siak_clean_b.cfg'
