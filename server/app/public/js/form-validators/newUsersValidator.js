...
function NewUsersValidator()
{
// build array maps of the form inputs & control groups //

	this.formFields = [ $('#newuser-tf'), $('#pass-tf'), $('#role-tf'), $('#teacher-tf'), $('#school-tf'),  $('#group-tf'),];
	this.controlGroups = [$('#newuser-cg'), $('#pass-cg'), $('#role-cg'), $('#teacher-cg'), $('#school-cg'),  $('#group-cg'),];
...
NewUsersValidator.prototype.showInvalidEmail = function()
{
	this.controlGroups[1].addClass('error');
	this.showErrors(['That email address is already in use.']);
}

NewUsersValidator.prototype.showInvalidUserName = function()
{
	this.controlGroups[2].addClass('error');
	this.showErrors(['That username is already in use.']);
}

NewUsersValidator.prototype.validateForm = function()
{
	var e = [];
