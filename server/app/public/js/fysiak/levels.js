...
(function() {
    ...
    Levels.avalanche = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.beachBalls = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.broadphase = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.circleStack = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.collisionFiltering = function(game) {
        var engine = game.engine,
            world = engine.world,
            mouseConstraint = game.mouseConstraint;
...
(function() {
    ...
    Levels.compositeManipulation = function(game) {
        var engine = game.engine,
            world = engine.world,
            sceneEvents = game.sceneEvents;
...
(function() {
    ...
    Levels.compoundStack = function(game) {
        var engine = game.engine,
            world = engine.world,
            size = 50;
...
(function() {
    ...
    Levels.engine = function(game) {
        ...
        return Engine.create(game.container, options);
    };
...
(function() {
    ...
    Levels.events = function(game) {
        var engine = game.engine,
            world = engine.world,
            mouseConstraint = game.mouseConstraint,
            sceneEvents = game.sceneEvents;
        
        // bind events (sceneEvents is only used for this game)
...
(function() {
    ...
    Levels.manipulation = function(game) {
        var engine = game.engine,
            world = engine.world,
            sceneEvents = game.sceneEvents;
...
(function() {
    ...
    Levels.mixedSolid = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.newtonsCradle = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.raycasting = function(game) {
        var engine = game.engine,
            world = engine.world,
            sceneEvents = game.sceneEvents,
            mouseConstraint = game.mouseConstraint;
...
(function() {
    ...
    Levels.restitution = function(game) {
        var engine = game.engine,
            world = engine.world;
...
(function() {
    ...
    Levels.slingshot = function(game) {
        var engine = game.engine,
            world = engine.world,
            mouseConstraint = game.mouseConstraint;
...
(function() {
    ...
    Levels.staticFriction = function(game) {
        var engine = game.engine,
            world = engine.world,
            sceneEvents = game.sceneEvents;
...
(function() {
    ...
    Levels.timescale = function(game) {
        var engine = game.engine,
            world = engine.world,
            sceneEvents = game.sceneEvents;
...
(function() {
    ...
    Levels.wreckingBall = function(game) {
        var engine = game.engine,
            world = engine.world;
