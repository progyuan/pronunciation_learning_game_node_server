...
{
	host 	    : process.env.EMAIL_HOST || process.env.HOSTNAME,
...
{
	var link = 'https://'+process.env.HOST+'/'+ process.env.BASEURL +'/reset-password?e='+o.email+'&p='+o.pass;
	var html = "<html><body>";
		html += "Hi "+o.name+",<br><br>";
		html += "Your username is <b>"+o.user+"</b><br><br>";
		html += "<a href='"+link+"'>Click here to reset your password</a><br><br>";
		html += "Cheers,<br>";
		html += "SIAK folks<br><br>";
		html += "</body></html>";
